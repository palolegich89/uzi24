...
/*$arFilter = Array("IBLOCK_ID"=>IntVal(IB_CONTENT), "ACTIVE_DATE"=>"Y", "ACTIVE"=>"Y", "DEPTH_LEVEL"=>1/*, "CODE"=>$arResult["VARIABLES"]["SECTION_CODE"]*//*);
...
<?$this->EndViewTarget();*/?>
<?/*$ELEMENT_ID = getIdByCode($arResult["VARIABLES"]["ELEMENT_CODE"], IB_CONTENT, IBLOCK_ELEMENT);
$db_old_groups = CIBlockElement::GetElementGroups($ELEMENT_ID, true);
while($ar_group = $db_old_groups->Fetch()){
    $ar_new_groups[] = $ar_group["ID"];
}
pre_dump($ar_new_groups);
*/?>
<?$this->SetViewTarget('aside_sidebar');?>
	<div class="page__sidebar">
		<h4 class="page__sidebar-title">Услуги</h4>
